...
class UriExtensionsSpec :
    FunSpec({

        context("URI.buildRdapUri() with IPv4 addresses") {
            ...
            withData(
                ...
                val result = uri.buildRdapUri(ipAddress)

                result.toString() shouldBe expected
            }
        }

        context("URI.buildRdapUri() with IPv6 addresses") {
        ...
        context("URI.buildRdapUri() with various base URIs") {
